    ...
    def decorator(func):
        ...
        def wrapper(*args, **kwargs):
            ...
            try:
                ...
                if kw_api.log:
                    kw_api.log.sudo().mark_processed()
...
class KwApiDispatcher(Dispatcher):
    ...
    def dispatch(self, endpoint, args):
        ...
        raw_body = self.request.httprequest.get_data(as_text=True) or ''
        try:
            jsonrequest = json.loads(raw_body or '{}')
        except Exception:
            jsonrequest = {}

        self.request.params.update(
            dict(jsonrequest.get('params', {}), **args)
        )
