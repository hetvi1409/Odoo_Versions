...

{
    ...
    'price': 90,
    'currency': 'EUR',
    'depends': ['base', 'stock', 'base_geolocalize','sale_management'],
    'data': [
    ...
    'assets': {
        'web.assets_backend': [
            ...
            'aspl_delivery_plan_ee/static/src/css/images/layers.png',

            # 'aspl_delivery_plan_ee/static/lib/leaflet/leaflet.css',
            # 'aspl_delivery_plan_ee/static/lib/leaflet/leaflet.js',
