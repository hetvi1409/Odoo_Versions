...
class AccountMove(models.Model):
    ...
    def _l10n_mx_edi_add_invoice_cfdi_values(self, cfdi_values, percentage_paid=None, global_invoice=False):
        ...
        # Date.
        document_date = datetime.combine(self.invoice_date, time(hour=23, minute=59, second=00))
        document_post_time = self.l10n_mx_edi_post_time or self._l10n_mx_edi_get_datetime_now_with_mx_timezone(cfdi_values).replace(tzinfo=None)
