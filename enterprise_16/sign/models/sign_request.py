...
class SignRequest(models.Model):
    ...
    def _check_signers_roles_validity(self):
        for sign_request in self:
            ...
            print('sign_request:',sign_request)
            print('template_id:',sign_request.template_id)
            # print('sign_item_ids:',sign_request.template_id.sign_item_ids)
            print('template_roles:',template_roles)

            sign_request_items = sign_request.request_item_ids
            print('sign_request:',sign_request)
            print('request_item_ids:',sign_request.request_item_ids)
            print('sign_request_items:',sign_request_items)

            print('sign_request_items.role_id.ids:',sign_request_items.role_id.ids)
    ...
    # sign_request: sign.request(12, )
    # template_id: sign.template(1, )
    # template_roles: sign.item.role(1, )
    # sign_request: sign.request(12, )
    # request_item_ids: sign.request.item(21, 22)
    # sign_request_items: sign.request.item(21, 22)
    # sign_request_items.role_id.ids: [3, 5]
