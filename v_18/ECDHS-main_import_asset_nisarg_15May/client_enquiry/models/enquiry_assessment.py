...
class EnquiryAssessment(models.Model):
    ...
    assessment_folder_id = fields.Many2one('documents.folder',
    ...
    circulation_folder_id = fields.Many2one('documents.folder', string="Circulation Folder")
    valuation_document_id = fields.Many2one('documents.document', string="Valuation Document")
    valuation_folder_id = fields.Many2one('documents.folder', string='Valuation folder')
    transaction_folder_id = fields.Many2one('documents.folder', string="Transaction folder")
    board_meeting_folder_id = fields.Many2one('documents.folder', string='Board meeting folder')
    board_document_ids = fields.Many2many('documents.document',
                                          'board_document_rel', string='Board documents')
    mayoral_meeting_folder_id = fields.Many2one('documents.folder',
    ...
    council_meeting_folder_id = fields.Many2one('documents.folder',
    ...
    technical_growth_ids = fields.Many2many('ir.attachment',
                                              ...
                                              readonly=True)
    technical_growth_folder_id = fields.Many2one('documents.folder',
    ...
    executive_management_ids = fields.Many2many('ir.attachment',
                                              ...
                                              readonly=True)
    executive_management_folder_id = fields.Many2one('documents.folder',
                                              string='Technical growth folder')
    ...
    council_79_attachment_ids = fields.Many2many('ir.attachment',
                                                 ...
                                                 string="Council 79 Section "
                                                        "Report")
    council_79_folder_id = fields.Many2one('documents.folder',
    ...
    sub_mayoral_folder_id = fields.Many2one('documents.folder',
    ...
    user_domain_ids = fields.Many2many('res.users', string='Assignee',
    ...
    section_79_folder_id = fields.Many2one('documents.folder', string='Section 79 Folder')
    ...
    def create(self, values):
        ...
        if not values.get('enquiry_id') and not values.get('property_id'):
            raise ValidationError(_('Please provide a enquiry or a property'))
    ...
    def send_compile_report(self):
        ...
        try:
            template_id = ir_model_data._xmlid_lookup(
                'client_enquiry.email_template_circulation_report')[2]
        except ValueError:
            template_id = False
        try:
        ...
        # recipient_ids = [self.env.ref('client_enquiry.res_partner_jean').id,
        #                  self.env.ref('client_enquiry.res_partner_eric').id,
        #                  self.env.ref('client_enquiry.res_partner_gift').id,
        #                  self.env.ref('client_enquiry.res_partner_chris').id,
        #                  self.env.ref('client_enquiry.res_partner_thelma').id,
        #                  self.env.ref('client_enquiry.res_partner_melanie').id,
        #                  self.env.ref('client_enquiry.res_partner_lisa').id,
        #                  self.env.ref('client_enquiry.res_partner_sello').id,
        #                  self.env.ref('client_enquiry.res_partner_gauteng').id,
        #                  self.env.ref('client_enquiry.res_partner_matome').id,
        #                  self.env.ref('client_enquiry.res_partner_beauty').id,
        #                  self.env.ref('client_enquiry.res_partner_cebo').id,
        #                  self.env.ref('client_enquiry.res_partner_jpc').id,
        #                  self.env.ref('client_enquiry.res_partner_veli').id,
        #                  self.env.ref('client_enquiry.res_partner_peto').id,
        #                  self.env.ref('client_enquiry.res_partner_mickey').id]
    ...
    def action_signed_document(self):
        """Method for open the document"""
        print(self.transaction_folder_id)
        folder = self.env['documents.folder'].sudo().search([('parent_folder_id', '=', self.transaction_folder_id.id)])
        print(folder, 'folder')
        return {
            'name': _('Documents'),
            'res_model': 'documents.document',
