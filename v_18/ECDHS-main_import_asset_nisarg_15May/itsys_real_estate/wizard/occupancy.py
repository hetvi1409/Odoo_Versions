...
class occupancy_check(models.TransientModel):
    ...
    region_ids= fields.Many2many('regions', string='Portfolio',
                                     help="Only selected Portfolios will be printed. "
                                          "Leave empty to print all Portfolios.")
