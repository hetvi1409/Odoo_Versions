...
class building_unit(models.Model):
    ...
    region_id= fields.Many2one('regions', string='Portfolio', related='building_id.region_id', store=True, readonly=True)
    ...
    local_municipality = fields.Char(string='Local Municipality')
    township = fields.Char(string='Township')
    local_municipality_2 = fields.Char(string='Local Municipality (2)')  # Optional
    registration_division = fields.Char(string='Registration Division')
    rural_urban = fields.Selection([
        ('rural', 'Rural'),
        ('urban', 'Urban')
    ], string='Rural/Urban')
    erf_no = fields.Char(string='ERF No')
    farm_no = fields.Char(string='Farm No')
    farm_portion = fields.Char(string='Farm Portion')
    farm_name = fields.Char(string='Farm Name')
    portion_name = fields.Char(string='Portion Name')
    sg_diagram_no = fields.Char(string='SG Diagram No')
    extent_ha = fields.Float(string='Extent (HA)')
    title_deed_no = fields.Char(string='Title Deed No')
    registered_owner = fields.Char(string='Registered Owner as on Aktek')
    land_use = fields.Char(string='Land Use')
    user_department = fields.Char(string='User Department')
    location_street_address = fields.Char(string='Location/Street Address')
    lpi_code = fields.Char(string='LPI Code')
    property_category_type = fields.Char(string='Property Category Type')
    gps_x = fields.Float(string='GPS Co-ordinates-X')
    gps_y = fields.Float(string='GPS Co-ordinates-Y')
    other_land_property_use = fields.Char(string='Other Land Property Use')
    other_land_use_type = fields.Char(string='Other Land Use Type')
    land_claim = fields.Boolean(string='Land Claim')
    claimant_name = fields.Char(string='Claimant Name')
    audit_status = fields.Char(string='Audit Status')
...
class unit_attachment_line(models.Model):
    ...
    _description = "Unit Atteachment Line"
