...
class report_ownership_contract_bi(models.Model):
    ...
    contract_unit= fields.Many2one('product.template', 'Sub Property', readonly=True)
    contract_building= fields.Many2one('building', 'Property', readonly=True)
    contract_region= fields.Many2one('regions', 'Portfolio', readonly=True)
