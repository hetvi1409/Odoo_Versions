# __manifest__.py
{
    ...
    "license": "LGPL-3",
    'icon': '/insurance_management/static/description/icon.png',
    'image': '/insurance_management/static/description/icon.png',
    ...
    "assets": {
        "web.assets_backend": [
            "insurance_management/static/src/css/app_menu_wrap.css",
        ],
    },
    "installable": True,
    "application": True,
