...
class WebsiteProperty(http.Controller):
    ...
    def list_properties(self, page=1, **kwargs):
        ...
        return request.render(
            'real_estate_management.property_list_template', {
                'units': units,
                'view_type': view_type,
                'page': page,
    ...
    def for_sale(self, **kwargs):
        ...
        return request.render(
            "real_estate_management.website_property_search_page", {
                'provinces': provinces,
    ...
    def for_rent(self, **kwargs):
        ...
        # Render unified template
        return request.render(
            "real_estate_management.website_property_search_rent_page", {
                'provinces': provinces,
                'properties': properties,
                'property_count': property_count,
                'province_id': int(
    ...
    #     return request.render("real_estate_management.website_property_search_page", {
    #         'properties': properties,
    #         'provinces': provinces,
