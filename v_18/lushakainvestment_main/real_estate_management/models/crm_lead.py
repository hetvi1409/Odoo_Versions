...
class CrmLead(models.Model):
    ...
    def action_view_property(self):
        ...
        return {
            ...
            'name': 'Property',
            'view_mode': 'form',
            'res_model': self.property_id._name,
    ...
    def action_view_ownership_contract(self):
        """View booking"""
        self.ensure_one()
        return {
            'type': 'ir.actions.act_window',
            ...
            'view_mode': 'form',
            'res_model': self.ownership_contract_id._name,
            'res_id': self.ownership_contract_id.id,
            'context': "{'create': False}"
        }

    def action_create_rental_contract(self):
        """"""
        if self.enquiry_type == 'rent':
            return {
                "type": "ir.actions.act_window",
                ...
                "context": {
                    ...
                    'default_building': self.property_id.id,
                    'default_building_unit': self.building_id.id,
                },
            }
        elif self.enquiry_type == 'buy':
            return {
                "type": "ir.actions.act_window",
