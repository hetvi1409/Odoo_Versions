class amChartsComponent {
    ...
    makeBulletBarChart() {
        ...
        if ((self.metric).length >= 2) {
            ...
            self.configLabelBullet(series2); 
    ...
    makeRowLine() {
        ...
        function createLineSeries(field, i) {
            ...
            self.configLabelBullet(seriesLine); 
    ...
    makeScorecardTrend() {
        ...
        if (self.dimension == undefined) {
            ...
            $('#' + self.idElm).append(`
                <div class="row alert-warning seta_alert">
                    <div class="seta_alert_icon">
        ...
        if ((self.data).length >= 2) {
            ...
            <div style="max-width: 55%;">
                <div class="alert-warning seta_alert">
                    <div class="col">
    ...
    configLabelBullet(selfSeries){
        if (self.labelBullet) { 
            ...
            numberFormatter.numberFormat = "#.0a";
    ...
    showAlertDimension(container) {
        var dom_alert = `
            <div class="row alert-danger seta_alert">
                <div class="seta_alert_icon">
