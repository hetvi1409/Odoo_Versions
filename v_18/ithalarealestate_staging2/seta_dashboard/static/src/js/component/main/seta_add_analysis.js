...
var SETAAddAnalysis = SETADialog.extend({
    // jsLibs: [
    ...
    _loadAnalysisItems: function (selectAnalysis = false) {
        ...
        rpc('/web/dataset/call_kw/seta.analysis/ui_get_all', {
            model: 'seta.analysis',
            method: 'ui_get_all',
            args: [args],
            kwargs: {},
            ...
            self.allAnalysis.forEach(analysis => {
                var $content = $(renderToElement('SETASelectAnalysisItem', {
                    name: `${analysis.name}`,
                    id: analysis.id,
    ...
    _loadFields: function (ev) {
        ...
        if (self.selectedTable) {
            self.$fieldMetricContainer.empty();
            self.$fieldDimensionContainer.empty();
            rpc('/web/dataset/call_kw/seta.table.field/search_read', {
    ...
    _loadQuery: function () {
        ...
        if (self.selectedTable) {
            ...
            rpc('/web/dataset/call_kw/seta.table/read', {
                model: 'seta.table',
                method: 'read',
    ...
    _loadCategories: function () {
        ...
        `)
        rpc('/web/dataset/call_kw/seta.analysis.category/search_read', {
    ...
    _testQuery: function (ev) {
        ...
        if (self.selectedTable) {
            rpc('/web/dataset/call_kw/seta.table/ui_test_query', {
                model: 'seta.table',
        ...
        if (self.selectedTable) {
            ...
            new swal({
                ...
                if (result.isConfirmed) {
                    if (self.selectAnalysis) {
                        rpc('/web/dataset/call_kw/seta.analysis/ui_execute_query', {
                            model: 'seta.analysis',
                        ...
                        rpc('/web/dataset/call_kw/seta.table/ui_execute_query', {
                            model: 'seta.table',
                            method: 'ui_execute_query',
                            args: [self.selectedTable, query],
                            kwargs: {},
    ...
    _onClickDeleteAnalysis: function (ev) {
        ...
        if (self.selectedAnalysis) {
            new swal({
                ...
                if (result.isConfirmed) {
                    rpc('/web/dataset/call_kw/seta.analysis/unlink', {
                        model: 'seta.analysis',
                        method: 'unlink',
    ...
    _onClickSaveTable: function (ev) {
        ...
        if (tableName && self.selectedSource) {
            ...
            rpc('/web/dataset/call_kw/seta.table/create', {
                model: 'seta.table',
                method: 'create',
                args: [data],
                kwargs: {},
    ...
    _createAnalysis: function (data) {
        var self = this;
        rpc('/web/dataset/call_kw/seta.analysis/create', {
            model: 'seta.analysis',
            method: 'create',
            args: [data],
            kwargs: {},
...
export default SETAAddAnalysis;