    ...
    def create(self, vals_list):
        for vals in vals_list:
            if vals.get('name', 'New') == 'New':
                vals['name'] = self.env['ir.sequence'].next_by_code('ownership.contract') or 'New'
        return super(ownership_contract, self).create(vals_list)
...
class loan_line_rs_own(models.Model):
    ...
    total_remaining_amount= fields.Float('Remaining Amount',)
...
class own_attachment_line(models.Model):
    ...
    _description = "Own Attachment Line"
