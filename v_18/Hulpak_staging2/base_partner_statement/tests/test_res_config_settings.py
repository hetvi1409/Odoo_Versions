...
class TestResConfigSettings(TransactionCase):
    ...
    def test_groups(self):
        ...
        self.assertFalse(
            self.admin_user._has_group("base_partner_statement.group_outstanding_statement")
        )
        self.assertTrue(
            self.admin_user._has_group("base_partner_statement.group_activity_statement")
        )
        res = (
