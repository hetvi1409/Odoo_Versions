...
class res_partner(models.Model):
    ...
    @api.depends('sup_overdue_ids','sup_filter_by','sup_period_from','sup_period_to' )
    ...
    sup_ageing_length = fields.Integer('Sup Days Length' , compute='_compute_sup_overdue_ids', default= 30, readonly=False, store=True)
    ...
    def action_sup_overdue_statement_print(self):
        ...
        return self.env.ref('gt_customer_overdue_statement.print_supplier_overdue_statement_report').report_action(self)
    ...
    def action_sup_overdue_statement_send(self):
        ...
        try:
            template_id = self.env.ref('gt_customer_overdue_statement.email_template_supplier_overdue_statements').id
        except ValueError:
            template_id = False
        try:
