...
class FinancialStatementTracking(models.Model):
    ...
    previous_stage_id = fields.Selection([('draft','Draft'),('preparer', 'Preparer'),
        ('first_reviewer', 'First Reviewer'),
        ('second_reviewer', 'Second Reviewer'),
        ('approved', 'Approved'),
        ('reverted', 'Reverted'),
        ('rejected', 'Rejected')],
                             default="draft", string="Previous Stage")
    new_stage_id = fields.Selection([('draft','Draft'),('preparer', 'Preparer'),
        ('first_reviewer', 'First Reviewer'),
        ('second_reviewer', 'Second Reviewer'),
        ('approved', 'Approved'),
        ('reverted', 'Reverted'),
