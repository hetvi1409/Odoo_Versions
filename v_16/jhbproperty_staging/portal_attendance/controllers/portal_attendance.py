...
class PortalAttendance(portal.CustomerPortal):
    def _prepare_home_portal_values(self, counters):
        ...
        attendance_count = request.env['hr.attendance'].search_count(
            [('is_portal_attendance', '=', True), ('employee_id', '=', employee_id.id)])
        values.update({
    ...
    def attendance_checkin(self):
        ...
        return request.render("portal_attendance.check_in_template", values)
    ...
    def attendance_creation(self):
        ...
        return request.render(
            "portal_attendance.check_in_welcome_note_template", values)
    ...
    def attendance_checkout(self):
        ...
        return request.render("portal_attendance.check_out_template",
                              values)
    ...
    def attendance_final_checkout(self):
        ...
        return request.render("portal_attendance.portal_last_checkout",
                              values)
    ...
    def attendance_search_sort_view(self, page=1, search=None,
        ...
        page_detail = pager(url='/attendance/list',
                            ...
                            url_args={'search': search,
                                      'search_in': search_in,
                                      'filterby': filterby})
        attendance_domain = [('is_portal_attendance', '=', True),
                             ('employee_id', '=', employee_id.id)]
        if search_domain:
        ...
        return request.render(
            "portal_attendance.portal_list_attendance_order", vals)