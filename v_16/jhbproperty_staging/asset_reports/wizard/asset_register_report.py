...
class AssetRegisterReports(models.TransientModel):
    ...
    def get_xlsx_report(self, data, response):
        ...
        sql_query = """SELECT a.identification_number,
                            ...
                            a.description, 
                            a.identification_number, a.description,
                            a.barcode_past_year, a.asset_barcode, at.name, ac.name, 
                            sac.name, a.name, a.state, a.acquisition_date, 
                            a.disposal_date, '', a.impairment_date, 
                            a.write_date, a.current_condition_this_year, '', a.method, 
                            ...
                            '', a.fair_value_less_cost_to_sell, 
                            a.accumulated_depreciation_2023, '', '', 
                            a.impairment, '', a.carrying_amount, '',
                            '', '', '', 
                            '', ''
