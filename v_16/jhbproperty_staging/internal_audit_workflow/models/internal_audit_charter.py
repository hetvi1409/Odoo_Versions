...
class InternalAuditCharter(models.Model):
    _inherit = 'internal.audit.charter'
    ...
    def _compute_can_edit(self):
        ...
        for record in self:
            ...
            if record.stages == 'preparer' and current_user == record.preparer_id:
                record.can_edit = True

            # Reviewer Stage → Reviewer 1
            elif record.stages == 'second_reviewer' and current_user == record.reviewer_id:
                record.can_edit = True
