...
class setaTable(models.Model):
    ...
    source_id = fields.Many2one('seta.data.source', string='Data Source', required=True, ondelete='cascade')
    ...
    def _valid_field_parameter(self, field, name):
        # I can't even
        return name == 'force_save' or super()._valid_field_parameter(field, name)
    ...
    def create(self, vals):
        ...
        rec = super(setaTable, self).create(vals)
    ...
    def get_table_fields(self):
        ...
        if self.is_stored:
            ...
            if not self.source_id.type:
                raise ValidationError('Add Type in Data Source')
