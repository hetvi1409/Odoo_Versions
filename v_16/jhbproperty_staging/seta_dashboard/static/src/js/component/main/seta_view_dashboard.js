odoo.define('seta_dashboard.setaViewDashboard', function (require) {
    "use strict";

    var Widget = require('web.Widget');
    var setaViewDashboardBlock = require('seta_dashboard.setaViewDashboardBlock');
