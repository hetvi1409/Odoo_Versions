...
class setaDashboard(models.Model):
    ...
    def _default_theme(self):
        default_theme = False
        try:
            default_theme = self.env.ref('seta_dashboard.seta_dashboard_theme_colorful').id
    ...
    theme_id = fields.Many2one(comodel_name='seta.dashboard.theme', string='Theme', default=_default_theme)
