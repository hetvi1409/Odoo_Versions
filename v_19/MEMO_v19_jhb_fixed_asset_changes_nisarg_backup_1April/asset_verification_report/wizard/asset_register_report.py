...
class AssetRegisterReport(models.TransientModel):
    ...
    def get_xlsx_report(self, data, response):
        ...
        for asset in assets:
            ...
            # asset.custodian_department_id.name or
