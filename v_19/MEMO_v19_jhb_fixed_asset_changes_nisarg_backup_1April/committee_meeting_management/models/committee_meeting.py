...
class CommitteeMeeting(models.Model):
    ...
    note_id = fields.Many2one('project.task', string="Notes", help="Notes for the meeting")
    note = fields.Html(string="Note", help="Note for the meeting", related='note_id.description')
    note_ids = fields.Many2many('project.task', string="Notes",
                                help="Notes for the agenda", order='id asc')
    note_review_ids = fields.Many2many('project.task', 'note_review_rel', string="Notes",
                                help="Notes for the agenda", order='id asc')
