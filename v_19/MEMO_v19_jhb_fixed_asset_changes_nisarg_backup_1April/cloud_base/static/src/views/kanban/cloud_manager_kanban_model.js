...
console.log('kanban model...')
export class CloudManagerKanbanModel extends CrmKanbanModel {
    /*
...
export class CloudManagerKanbanRecord extends CrmKanbanModel.Record {
    /**
