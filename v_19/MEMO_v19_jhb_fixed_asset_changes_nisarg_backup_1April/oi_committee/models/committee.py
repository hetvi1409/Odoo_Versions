...
class Committee(models.Model):
    ...
    type_id = fields.Many2one('committee.type', required=True, index=True, readonly=False, states=_states)
    ...
    date_start = fields.Date(required=True, default=fields.Date.today, readonly=False, states=_states)
    date_end = fields.Date(readonly=False, states=_states)
    subject = fields.Char(readonly=False, states=_states)
