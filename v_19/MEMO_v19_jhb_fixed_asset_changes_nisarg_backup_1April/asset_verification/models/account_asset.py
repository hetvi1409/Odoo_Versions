...
class AccountAsset(models.Model):
    ...
    condition = fields.Char(string='Condition', help='Condition of the asset', readonly=True, store=True,
    ...
    def _compute_condition(self):
        for asset in self:
            ...
            latest_history = all_histories.sorted(key=lambda h: h.create_date or fields.Datetime.now(), reverse=True)[
                :1]
