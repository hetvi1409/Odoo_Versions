...
class AssetDepreciationReports(models.TransientModel):
    ...
    def print_xlsx(self):
        ...
        return {
            ...
            'data': {'model': 'asset.depreciation.reports',
    ...
    def get_xlsx_report(self, data, response):
        ...
        sql_query = """SELECT a.identification_number, a.description, at.name,
                        ac.name, sac.name, a.name, a.state, a.condition,
                        a.method,  a.method_period, a.useful_life_month, 
                        a.useful_life_day, a.remaining_useful_life_month,
                        a.remaining_useful_life_day, a.days_from_last_run, 
                        a.original_value, move.id, m_move.id, a.accumulated_depreciation,
                        a.carrying_amount
