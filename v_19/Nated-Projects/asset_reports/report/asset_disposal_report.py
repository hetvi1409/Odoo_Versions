...
class AssetDisposal(models.AbstractModel):
    _name = 'report.asset_reports.report_asset_disposal'
    _description = 'Asset disposal Report'

    @api.model
    def _get_report_values(self, docids, data=None):
        sql_query = """  SELECT a.identification_number, a.name, a.description, a.disposal, a.acquisition_date, p.name, a.state
