...
class AssetAcquisition(models.AbstractModel):
    _name = 'report.asset_reports.report_asset_acquisition'
    _description = 'Asset acquisition Report'

    @api.model
    def _get_report_values(self, docids, data=None):
        sql_query = """SELECT a.identification_number, a.name, a.description, a.original_value, a.acquisition_date, a.acquisition_date, p.name
