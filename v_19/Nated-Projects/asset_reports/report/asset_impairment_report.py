...
class AssetImpairmentReport(models.AbstractModel):
    ...
    def _get_report_values(self, docids, data=None):
        sql_query = """SELECT a.identification_number, a.name, a.description,
                        a.book_value, a.re_valued_value, 
                        a.revaluation_date, a.reason_impairment, p.name, a.is_impaired, a.state
