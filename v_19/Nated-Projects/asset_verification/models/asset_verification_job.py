...
class AssetVerificationJob(models.Model):
    ...
    def update_assets(self):
        print(self.job_location_id,'adwsddads')
    ...
    def create(self, vals):
        ...
        job_location_id = vals.get('job_location_id')
    ...
    def generate_excel_report(self):
        ...
        for line in self.asset_ids:
            if line.verified:
                ...
                worksheet.write(row, 4, line.custodian_id.name if line.custodian_id else '')  # Custodian
