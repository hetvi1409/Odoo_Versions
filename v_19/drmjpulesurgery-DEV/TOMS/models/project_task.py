...
#                                             related="contact_clinical_final_rx_id.name")
    ...
    contact_od_va = fields.Char(string="Contact VA", related="contact_clinical_final_rx_id.od_va")
    ...
    contact_os_va = fields.Char(string="Contact VA ", related="contact_clinical_final_rx_id.os_va")
    ...
    def _track_template(self, tracking):
        ...
        if self.stage_id.sms_template_id and self.mobile:
