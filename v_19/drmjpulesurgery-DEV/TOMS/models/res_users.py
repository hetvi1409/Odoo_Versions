...
class ResCompany(models.Model):
    ...
    enable_virtual_bank = fields.Boolean()
    virtual_suspense = fields.Many2one('account.account',  check_company=True)
    virtual_bank = fields.Many2one('account.journal', domain="[('type','=','bank')]")