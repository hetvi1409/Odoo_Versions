...
#             ('partial', _('Select products manually (choose for stock take)'))]
#
...
#         return res_filter
#
#     @api.onchange('stock_take_id')
#     def onchange_stock_take_id(self):
#         if self.stock_take_id:
#             self.filter = 'partial'
#         else:
#             self.filter = 'none'
#
...
#                         if 'product_qty' in line_values.keys() and 'theoretical_qty' in line_values.keys():
#                             if int(line_values['product_qty']) < int(line_values['theoretical_qty']):
#                                 line_values.update({'is_new_missing_stock': True})
#                             if line_values['product_qty'] > line_values['theoretical_qty']:
#                                 line_values.update({'is_over_stock': True})
