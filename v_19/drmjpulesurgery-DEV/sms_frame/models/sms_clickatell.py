...
class SmsGatewayClickatell(models.Model):
    ...
    def send_message(self, sms_gateway_id, from_number, to_number, sms_content, my_model_name='', my_record_id=0, media=None, queued_sms_message=None):
        ...
        if record.mobile or record.phone or to_number:
            ...
            raise UserError(_("Please Enter Mobile Number or Phone Number for this record!!!..."))
...
class SmsGatewaymyMobileapi(models.Model):
    _name = "sms.gateway.mymobileapi"
    _description = "SMS Gateway Mymobileapi"
...
class SmsGatewaySmsportal(models.Model):
    _name = "sms.gateway.smsportal"
    _description = "SMS Gateway Smsportal"
