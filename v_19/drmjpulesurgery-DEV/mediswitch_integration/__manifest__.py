...

{
    ...
    'depends': ['base', 'account', 'TOMS', 'contacts'],
    'data': [
        ...
        #        'wizard/daily_invoice_popup_wizard.xml',
        'data/echo_operation_scheduler.xml',
        'data/mediswitch_cron.xml',
        #        'report/receipts_payments_report.xml',
        #        'report/recepits_payments_report_document.xml'
    ],
    # 'assets': {
    #     'web.assets_backend': [
    #         '/mediswitch_integration/static/src/js/global_fetch.js',
    #         '/mediswitch_integration/static/src/xml/global_fetch.xml',
    #     ],
    # },
    # 'qweb': [
