    ...
    async load_data() {
        ...
        */
        ...
        try {
            ...
            if (type) {
                // threshold = taging this from config parameter
                const threshold = parseFloat(await this.orm.call('ir.config.parameter', 'get_param', ['asset_registry.minor_major_threshold', '1000']));
                if (type == 'minor'){
